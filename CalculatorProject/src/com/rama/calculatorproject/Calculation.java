...
public class Calculation {
	...
	protected double performOperation(String operator) {
		...
		if (operator.equals(CLEAR)) {
			...
			mOperand = Math.sin(Math.toRadians(mOperand)); // Math.toRadians(mOperand)
															// converts result
															// to degrees
		} else if (operator.equals(COSINE)) {
			mOperand = Math.cos(Math.toRadians(mOperand)); // Math.toRadians(mOperand)
															// converts result
															// to degrees
		} else if (operator.equals(TANGENT)) {
			mOperand = Math.tan(Math.toRadians(mOperand)); // Math.toRadians(mOperand)
															// converts result
															// to degrees
		} else {
